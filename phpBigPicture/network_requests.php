...
request_endpoint($client, 'https://pokeapi.co/api/v2/pokemon/ditto');
request_endpoint($client, 'https://pokeapi.co/api/v2/pokemon/caterpie');
request_endpoint($client, 'https://pokeapi.co/api/v2/pokemon/pidgey');
